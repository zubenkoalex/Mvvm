...
namespace Duvalin.Models
{
    ...
    {
        public Database(DbContextOptions options) : base(options) { } // для app.xaml.cs, там процесс создания бд
        ...
        //{
        //    new Car() { Mark = 1, Mileage = 184000,Price=2030000,ReleaseYear=2009,Pacage=1, Picture ="C:\\Users\\Александр\\Desktop\\Учеба\\Дувалин Курсач\\Пикчи\\3series_chorni.jpeg"},
        //    new Car() {Mark = 1, Mileage = 84000,Price=2500000,ReleaseYear=2012,Pacage=2, Picture ="C:\\Users\\Александр\\Desktop\\Учеба\\Дувалин Курсач\\Пикчи\\3series_serai.jpg"},
        //    new Car() {Mark = 2, Mileage = 15000,Price=4000000,ReleaseYear=2019,Pacage=3, Picture ="C:\\Users\\Александр\\Desktop\\Учеба\\Дувалин Курсач\\Пикчи\\a5.jpeg"},
        //    new Car() {Mark = 3, Mileage = 44000,Price=3420000,ReleaseYear=2016,Pacage=4, Picture ="C:\\Users\\Александр\\Desktop\\Учеба\\Дувалин Курсач\\Пикчи\\m5.jpeg"},
        //    new Car() {Mark = 4, Mileage = 600000,Price=1500000,ReleaseYear=1996,Pacage=5, Picture ="C:\\Users\\Александр\\Desktop\\Учеба\\Дувалин Курсач\\Пикчи\\supra.jpeg"},
        //};
